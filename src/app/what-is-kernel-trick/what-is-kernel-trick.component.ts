...
export class WhatIsKernelTrickComponent extends Slide {
  ...
  _kernel = '<mi>k</mi><mrow><mo form="prefix" stretchy="false">(</mo><msup class="data"><mi>x</mi><mi>(i)</mi></msup><mo>,</mo><mi>x</mi><mo form="postfix" stretchy="false">)</mo></mrow>'
  kernel = '<math display="inline">'+this._kernel+'</math>'
  linearKernel = '<math><mrow><msub><mi>x</mi><mn>j</mn></msub><mi>x</mi></mrow></math>'
  polynomialKernel = '<math><msup><mrow><mo form="prefix" stretchy="false">(</mo><msup><mi>x</mi><mn>(i)</mn></msup><mi>x</mi><mo>+</mo><mi>c</mi><mo form="postfix" stretchy="false">)</mo></mrow><mi>d</mi></msup></math>'
  rbfKernel = rbfKernel
  quadraticKernel = '<math>'+this._kernel+'<mo>=</mo><msup><mrow><mo form="prefix" stretchy="false">(</mo><msup><mi>x</mi><mn>(i)</mn></msup><mi>x</mi><mo form="postfix" stretchy="false">)</mo></mrow><mi>2</mi></msup></math>'
