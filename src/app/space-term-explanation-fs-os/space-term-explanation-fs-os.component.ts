...
@Component({
  selector: 'space-term-explanation-fs-os',
  styleUrls: ['./space-term-explanation-fs-os.component.scss'],
  templateUrl: './space-term-explanation-fs-os.component.pug',
})
/**
 * Visualizes
 * Feature Space -> Model -> Output Space
 */
export class SpaceTermExplanationFsOsComponents implements AfterViewInit {
